...
class UpdateUserRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        if (auth()->user()->position_id == UserConstant::GENERAL_DIRECTOR[0]) {
            return [
                ...
                'email' => ['required', 'email', 'regex:/^[a-zA-Z0-9~`!@#$%^&*()-_=+<>?,.\/\:;"\'{}]+$/',
                 new MaxLengthRule(255, 'Email'), Rule::unique('user')->ignore($this->id)],
                ...
                'password_confirmation' => ['required_with:password',
                 new MaxLengthRule(20, 'Password Confirmation')],
                //
            ];
        }
        ...
        return [
            'password' => ['nullable', 'min:8',
             'max:20', 'regex:/^[a-z0-9]+$/', 'same:password_confirmation'],
            'password_confirmation' => ['required_with:password', new MaxLengthRule(20, 'Password Confirmation')],
            //
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'password_confirmation.required_with' =>  MessagesUtil::getMessage('ECL001', ['Password Confirmation']),
        ];
    }
}
